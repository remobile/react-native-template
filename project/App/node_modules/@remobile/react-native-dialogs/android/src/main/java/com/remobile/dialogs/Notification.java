...
public class Notification extends CordovaPlugin {
    ...
    @ReactMethod
    public void beep(ReadableArray args, Callback success, Callback error) {
        executeReactMethod("beep", args, success, error);
    }

    @ReactMethod
    public void alert(ReadableArray args, Callback success, Callback error) {
        executeReactMethod("alert", args, success, error);
    }

    @ReactMethod
    public void confirm(ReadableArray args, Callback success, Callback error) {
        executeReactMethod("confirm", args, success, error);
    }

    @ReactMethod
    public void prompt(ReadableArray args, Callback success, Callback error) {
        executeReactMethod("prompt", args, success, error);
    }

    @ReactMethod
    public void activityStart(ReadableArray args, Callback success, Callback error) {
        executeReactMethod("activityStart", args, success, error);
    }

    @ReactMethod
    public void activityStop(ReadableArray args, Callback success, Callback error) {
        executeReactMethod("activityStop", args, success, error);
    }

    @ReactMethod
    public void progressStart(ReadableArray args, Callback success, Callback error) {
        executeReactMethod("progressStart", args, success, error);
    }

    @ReactMethod
    public void progressValue(ReadableArray args, Callback success, Callback error) {
        executeReactMethod("progressValue", args, success, error);
    }

    @ReactMethod
    public void progressStop(ReadableArray args, Callback success, Callback error) {
        executeReactMethod("progressStop", args, success, error);
    }
