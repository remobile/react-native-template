...
public class CFCallNumber extends CordovaPlugin {
    ...
    public static final String LOG_TAG = "RCTCall";
     ...
     * Constructor.
     */
    public CFCallNumber(ReactApplicationContext reactContext) {
        super(reactContext);
    }
    ...
    @ReactMethod
    public void callNumber(ReadableArray args, Callback success, Callback error) {
        executeReactMethod("callNumber", args, success, error);
    }
