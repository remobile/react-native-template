...
RCT_EXPORT_MODULE(Contacts)

RCT_EXPORT_CORDOVA_METHOD(newContact);
RCT_EXPORT_CORDOVA_METHOD(displayContact);
RCT_EXPORT_CORDOVA_METHOD(chooseContact);
RCT_EXPORT_CORDOVA_METHOD(pickContact);
RCT_EXPORT_CORDOVA_METHOD(search);
RCT_EXPORT_CORDOVA_METHOD(save);
RCT_EXPORT_CORDOVA_METHOD(remove);
