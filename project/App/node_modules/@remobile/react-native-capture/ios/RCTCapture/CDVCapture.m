...
RCT_EXPORT_MODULE(Capture)
RCT_EXPORT_CORDOVA_METHOD(captureAudio);
RCT_EXPORT_CORDOVA_METHOD(captureImage);
RCT_EXPORT_CORDOVA_METHOD(captureVideo);
RCT_EXPORT_CORDOVA_METHOD(getFormatData);
