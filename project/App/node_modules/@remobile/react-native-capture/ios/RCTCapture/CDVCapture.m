...
{
    // CDVInvokedUrlCommand* callbackId = [command argumentAtIndex:0];
...
- (void)imagePickerController:(UIImagePickerController*)picker didFinishPickingMediaWithInfo:(NSDictionary*)info
{
    ...
    CDVInvokedUrlCommand* callbackId = cameraPicker.callbackId;
...
- (id)initWithCommand:(CDVCapture*)theCommand duration:(NSNumber*)theDuration callbackId:(CDVInvokedUrlCommand*)theCallbackId
{
    if ((self = [super init])) {
...
- (UIInterfaceOrientationMask)supportedInterfaceOrientations
{
    ...
    UIInterfaceOrientationMask supported = [[CDVPlugin presentViewController]supportedInterfaceOrientations];
...
- (void)dismissAudioView:(id)sender
{
    ...
    [[[CDVPlugin presentViewController].presentedViewController presentingViewController] dismissViewControllerAnimated:YES completion:nil];
