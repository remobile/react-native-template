...
import com.remobile.capture.PendingRequests.Request;
...
//    }
    ...
    public Capture(ReactApplicationContext reactContext) {
    ...
    @ReactMethod
    public void captureAudio(ReadableArray args, Callback success, Callback error) {
        executeReactMethod("captureAudio", args, success, error);
    }

    @ReactMethod
    public void captureImage(ReadableArray args, Callback success, Callback error) {
        executeReactMethod("captureImage", args, success, error);
    }

    @ReactMethod
    public void captureVideo(ReadableArray args, Callback success, Callback error) {
        executeReactMethod("captureVideo", args, success, error);
    }
    ...
    private JSONObject createMediaFile(Uri data) {
        File fp = (new CordovaResourceApi(getReactApplicationContext())).mapUriToFile(data);
        JSONObject obj = new JSONObject();
        ...
        try {
            ...
            obj.put("localURL", fp.getAbsolutePath());
