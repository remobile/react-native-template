...
//    }
    ...
    public Capture(ReactApplicationContext reactContext, Activity activity) {
        super(reactContext);
    ...
    private void captureAudio(Request req) {
        ...
        this.cordova.startActivityForResult((CordovaPlugin) this, intent, req.requestCode+cordova.CAPTRUE_RESULT);
    }
    ...
    public void onActivityResult(int requestCode, int resultCode, final Intent intent) {
        if (requestCode < cordova.CAPTRUE_RESULT) {
            return;
        }
        requestCode -= cordova.CAPTRUE_RESULT;
    ...
    private JSONObject createMediaFile(Uri data) {
        CordovaResourceApi resourceApi = new CordovaResourceApi(getReactApplicationContext());
        File fp = resourceApi.mapUriToFile(data);
        JSONObject obj = new JSONObject();
