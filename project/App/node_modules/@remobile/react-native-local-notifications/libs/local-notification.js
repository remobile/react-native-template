...
exports.schedule = function (opts, callback, scope) {
    core.schedule(opts, callback, scope);
};
...
exports.update = function (opts, callback, scope) {
    core.update(opts, callback, scope);
};
...
exports.cancel = function (ids, callback, scope) {
    core.cancel(ids, callback, scope);
};
...
exports.isPresent = function (id, callback, scope) {
    core.isPresent(id, callback, scope);
};
...
exports.isScheduled = function (id, callback, scope) {
    core.isScheduled(id, callback, scope);
};
...
exports.isTriggered = function (id, callback, scope) {
    core.isTriggered(id, callback, scope);
};
...
exports.getScheduledIds = function (callback, scope) {
    core.getScheduledIds(callback, scope);
};
...
exports.getTriggeredIds = function (callback, scope) {
    core.getTriggeredIds(callback, scope);
};
...
exports.getScheduled = function () {
    core.getScheduled.apply(core, arguments);
};
...
exports.getAllScheduled = function (callback, scope) {
    core.getAllScheduled(callback, scope);
};
...
exports.getTriggered = function () {
    core.getTriggered.apply(core, arguments);
};
...
exports.getAllTriggered = function (callback, scope) {
    core.getAllTriggered(callback, scope);
};
...
exports.hasPermission = function (callback, scope) {
    core.hasPermission(callback, scope);
};
