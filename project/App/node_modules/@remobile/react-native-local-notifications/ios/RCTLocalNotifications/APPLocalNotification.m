...
// Event queue
@property (readonly, nonatomic, strong) NSMutableDictionary* eventQueue;
...
RCT_EXPORT_MODULE(LocalNotification)
...
RCT_EXPORT_CORDOVA_METHOD(deviceready);
RCT_EXPORT_CORDOVA_METHOD(hasPermission);
RCT_EXPORT_CORDOVA_METHOD(registerPermission);
RCT_EXPORT_CORDOVA_METHOD(schedule);
RCT_EXPORT_CORDOVA_METHOD(update);
RCT_EXPORT_CORDOVA_METHOD(cancel);
RCT_EXPORT_CORDOVA_METHOD(cancelAll);
RCT_EXPORT_CORDOVA_METHOD(clear);
RCT_EXPORT_CORDOVA_METHOD(clearAll);
RCT_EXPORT_CORDOVA_METHOD(isPresent);
RCT_EXPORT_CORDOVA_METHOD(isScheduled);
RCT_EXPORT_CORDOVA_METHOD(isTriggered);
RCT_EXPORT_CORDOVA_METHOD(getAllIds);
RCT_EXPORT_CORDOVA_METHOD(getScheduledIds);
RCT_EXPORT_CORDOVA_METHOD(getTriggeredIds);
RCT_EXPORT_CORDOVA_METHOD(getSingle);
RCT_EXPORT_CORDOVA_METHOD(getSingleScheduled);
RCT_EXPORT_CORDOVA_METHOD(getSingleTriggered);
RCT_EXPORT_CORDOVA_METHOD(getAll);
RCT_EXPORT_CORDOVA_METHOD(getScheduled);
RCT_EXPORT_CORDOVA_METHOD(getTriggered);

- (void) sendJSEvent:(NSString *)event withParams:(NSString *)params {
    [self.bridge.eventDispatcher sendAppEventWithName:[NSString stringWithFormat:@"RCT-LOCAL-NOTIFICATION-%@", event] body:params];
}
...
- (void) deviceready:(CDVInvokedUrlCommand*)command
{
    ...
    for (NSString* event in eventQueue) {
        NSString *params = eventQueue[event];
        [self sendJSEvent:event withParams:params];
    }
...
- (void) pluginInitialize
{
    ...
    eventQueue = [[NSMutableDictionary alloc] init];
...
- (void) fireEvent:(NSString*)event notification:(UILocalNotification*)notification
{
    ...
    if (deviceready) {
        ...
        [self.eventQueue setObject:params forKey:event];
    }
}
