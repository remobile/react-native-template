...
public class LocalNotification extends CordovaPlugin {
    ...
    public void getSingleScheduled(ReadableArray args, Callback success, Callback error) {
        String action = "getSingleScheduled";
        try {
            this.execute(action, JsonConvert.reactToJSON(args), new CallbackContext(success, error));
        } catch (Exception ex) {
            FLog.e(LOG_TAG, "Unexpected error:" + ex.getMessage());
    ...
    public void getSingleTriggered(ReadableArray args, Callback success, Callback error) {
        String action = "getSingleTriggered";
        try {
            this.execute(action, JsonConvert.reactToJSON(args), new CallbackContext(success, error));
        } catch (Exception ex) {
            FLog.e(LOG_TAG, "Unexpected error:" + ex.getMessage());
