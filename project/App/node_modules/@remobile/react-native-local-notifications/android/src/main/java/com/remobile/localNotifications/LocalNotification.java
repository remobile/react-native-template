...
import com.remobile.localNotifications.notification.Manager;
...
public class LocalNotification extends CordovaPlugin {
    ...
    private static LocalNotification self = null;
    ...
    private static Map<String, String> eventQueue = new HashMap<String, String>();

    /**
     * Constructor.
     */
    public LocalNotification(ReactApplicationContext reactContext) {
        super(reactContext);
        self = this;
    }
    ...
    @ReactMethod
    public void schedule(ReadableArray args, Callback success, Callback error) {
        executeReactMethod("schedule", args, success, error);
    }
    @ReactMethod
    ...
    @ReactMethod
    public void cancel(ReadableArray args, Callback success, Callback error) {
        executeReactMethod("cancel", args, success, error);
    }
    @ReactMethod
    public void cancelAll(ReadableArray args, Callback success, Callback error) {
        executeReactMethod("cancelAll", args, success, error);
    }
    @ReactMethod
    public void clear(ReadableArray args, Callback success, Callback error) {
        executeReactMethod("clear", args, success, error);
    }
    @ReactMethod
    public void clearAll(ReadableArray args, Callback success, Callback error) {
        executeReactMethod("clearAll", args, success, error);
    }
    @ReactMethod
    public void isPresent(ReadableArray args, Callback success, Callback error) {
        executeReactMethod("isPresent", args, success, error);
    }
    @ReactMethod
    public void isScheduled(ReadableArray args, Callback success, Callback error) {
        executeReactMethod("isScheduled", args, success, error);
    }
    @ReactMethod
    public void isTriggered(ReadableArray args, Callback success, Callback error) {
        executeReactMethod("isTriggered", args, success, error);
    }
    @ReactMethod
    public void getAllIds(ReadableArray args, Callback success, Callback error) {
        executeReactMethod("getAllIds", args, success, error);
    }
    @ReactMethod
    public void getScheduledIds(ReadableArray args, Callback success, Callback error) {
        executeReactMethod("getScheduledIds", args, success, error);
    }
    @ReactMethod
    public void getTriggeredIds(ReadableArray args, Callback success, Callback error) {
        executeReactMethod("getTriggeredIds", args, success, error);
    }
    @ReactMethod
    public void getSingle(ReadableArray args, Callback success, Callback error) {
        executeReactMethod("getSingle", args, success, error);
    }
    @ReactMethod
    public void getSingleScheduled(ReadableArray args, Callback success, Callback error) {
        executeReactMethod("getSingleScheduled", args, success, error);
    }
    @ReactMethod
    public void getSingleTriggered(ReadableArray args, Callback success, Callback error) {
        executeReactMethod("getSingleTriggered", args, success, error);
    }
    @ReactMethod
    public void getAll(ReadableArray args, Callback success, Callback error) {
        executeReactMethod("getAll", args, success, error);
    }
    @ReactMethod
    public void getScheduled(ReadableArray args, Callback success, Callback error) {
        executeReactMethod("getScheduled", args, success, error);
    }
    @ReactMethod
    public void getTriggered(ReadableArray args, Callback success, Callback error) {
        executeReactMethod("getTriggered", args, success, error);
    }
    @ReactMethod
    public void deviceready(ReadableArray args, Callback success, Callback error) {
        executeReactMethod("deviceready", args, success, error);
    }
    ...
    private static synchronized void deviceready () {
        ...
        for (Map.Entry<String, String> entry : eventQueue.entrySet()) {
            sendJavascript(entry.getKey(), entry.getValue());
        }
     ...
     */
    private static synchronized void sendJavascript(final String event, final String params) {

        if (!deviceready) {
            eventQueue.put(event, params);
            return;
        }
        self.getReactApplicationContext().getJSModule(DeviceEventManagerModule.RCTDeviceEventEmitter.class).emit("RCT-LOCAL-NOTIFICATION-"+event, params);
    }
