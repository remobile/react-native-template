...
public class SQLitePlugin extends CordovaPlugin {
    ...
    public void open(ReadableArray args, Callback success, Callback error) {
        executeReactMethod("open", args, success, error);
    }

    @ReactMethod
    public void close(ReadableArray args, Callback success, Callback error) {
        executeReactMethod("close", args, success, error);
    }

    @ReactMethod
    public void delete(ReadableArray args, Callback success, Callback error) {
        executeReactMethod("delete", args, success, error);
    }

    @ReactMethod
    public void executeSqlBatch(ReadableArray args, Callback success, Callback error) {
        executeReactMethod("executeSqlBatch", args, success, error);
    }

    @ReactMethod
    public void backgroundExecuteSqlBatch(ReadableArray args, Callback success, Callback error) {
        executeReactMethod("backgroundExecuteSqlBatch", args, success, error);
    }

    @ReactMethod
    public void echoStringValue(ReadableArray args, Callback success, Callback error) {
        executeReactMethod("echoStringValue", args, success, error);
    }
