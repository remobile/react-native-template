...
var CheckboxItem = function (_React$Component) {
    ...
    CheckboxItem.prototype.render = function render() {
        ...
        return React.createElement(
            ListItem,
            (0, _extends3["default"])({ prefixCls: listPrefixCls, style: style, className: wrapCls, extra: extra }, onClickProps, { thumb: React.createElement(_Checkbox2["default"], { prefixCls: prefixCls, defaultChecked: defaultChecked, checked: checked, name: name, onChange: onChange, disabled: disabled }) }),
            children
        );
    };
